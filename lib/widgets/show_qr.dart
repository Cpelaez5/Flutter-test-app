...
void showQrConfirmationDialog(BuildContext context, String token) {
  showDialog(
    context: context,
      ...
      return AlertDialog(
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: () {
              Navigator.of(context).pop(); // Cierra el diálogo
              showQrCode(context, token); // Llama a la función para mostrar el código QR
            },
...
void showQrCode(BuildContext context, String token) {
